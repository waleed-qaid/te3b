...
$("style").last().append(`
#rdark_mod.r_mod.one4{-webkit-appearance:none;outline:none;width:35px;height:35px;border-radius:50px;position:relative;transition:0.4s;background:url(https://i.ibb.co/3SnPT0J/sun.png) no-repeat center #212121;background-size:25px;cursor:pointer;margin-top:8px!important}#rdark_mod.r_mod.one4:checked{background:url(https://i.ibb.co/smDBC4X/moon.png) no-repeat center #000;background-size:25px}.one6{background-color:#3d3f42;transition:background-color 0.5s ease}#rdark_mod.r_mod.one4{display:flex!important}#users.one6 .uzr{background-color:#555!important}#dpnl.one6 .nosel.ninr.fl.uzr.label.bg{background-color:#555}#settings.one6 .borderg.corner{background-color:#555!important;border:0 solid #f4f4f4}#d2.one6 .u-msg.break{color:#d7d7d7!important}#d2.one6 .nosel.u-topic.dots.hand{color:#000!important}#d2.one6 .uzr.d-flex.mm.pmsgc{background-color:#555!important;border-bottom:1px solid #5b5b5b!important}#settings.one6 .label-primary{background-color:#2f2f2f!important}#rooms.one6 .label-primary{background-color:#2f2f2f!important}#rooms.one6 .nosel.d-flex.room{background-color:#555}#users.one6 .nosel.ninr.fl.uzr.label.bg{background-color:#2f2f2f!important}#wall.one6 .uzr.d-flex.mm{background-color:#959595}#d0.one6 .label-primary{background-color:#2f2f2f}#settings.one6 .borderg.corner{background-color:#555!important;border:0 solid #f4f4f4}#d2.one6{background-color:#3e3e3e!important}#settings.one6 .label-primary,.btn-primary,.bg-primary{background-color:#2f2f2f}#d0.one6 .label-primary,.btn-primary{background-color:#2f2f2f}#muteall.one6{background-color:mediumseagreen!important}#rooms.one6 .label-primary,.btn-primary{background-color:#2f2f2f}#users.one6 .tbox{background-color:#8a8a8a}#room.one6 #mic{background-color:#555}#room.one6 #mic .mic,#muteall{background-color:#2F2F2F}#room.one6 .break{background-color:#555}#room.one6 .tablebox.d-flex.footer.fl.light{background-color:#959595}#users.one1 .inroom.uzr{border-radius:5px;border:1px solid #fffefe;border-bottom:1px solid #fffefe}#users.one1 .inroom.uzr img.ustat{width:10px!important;height:10px;border-radius:50%}
