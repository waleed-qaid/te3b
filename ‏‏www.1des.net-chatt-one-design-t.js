...
$("style").last().append(`
#rdark_mod1.r_mod1.kbar4 {-webkit-appearance: none;outline: none;width: 35px;height: 35px;border-radius: 50px;position: relative;transition: 0.4s;background: url("https://i.ibb.co/3SnPT0J/sun.png")no-repeat center #212121;background-size: 25px;cursor: pointer;margin-top: 8px !important;}#rdark_mod1.r_mod1.kbar4:checked {background: url("https://i.ibb.co/smDBC4X/moon.png")no-repeat center #000;background-size: 25px;}.kbar6{background-color: #3d3f42;transition: background-color 0.5s ease;}#rdark_mod1.r_mod1.kbar4 {display: flex !important;}#users.kbar6 .uzr {background-color: #555 !important;}#dpnl.kbar6 .nosel.ninr.fl.uzr.label.bg {background-color: #555;}#settings.kbar6 .borderg.corner {background-color: #555 !important;border: 0px solid #f4f4f4;}#d2.kbar6 .u-msg.break {color: #d7d7d7 !important;}#d2.kbar6 .nosel.u-topic.dots.hand {color: #000 !important;}#d2.kbar6 .uzr.d-flex.mm.pmsgc {background-color: #555 !important;border-bottom: 1px solid #5b5b5b !important;}#settings.kbar6 .label-primary {background-color: #2f2f2f !important;}#rooms.kbar6 .label-primary {background-color: #2f2f2f !important;}#rooms.kbar6 .nosel.d-flex.room {background-color: #555;}#users.kbar6 .nosel.ninr.fl.uzr.label.bg {background-color: #2f2f2f !important;}#wall.kbar6 .uzr.d-flex.mm {background-color: #959595;}#d0.kbar6 .label-primary {background-color: #2f2f2f;}#settings.kbar6 .borderg.corner {background-color: #555 !important;border: 0px solid #f4f4f4;}#d2.kbar6 {background-color: #3e3e3e !important;}#settings.kbar6 .label-primary, .btn-primary, .bg-primary {background-color: #2f2f2f;}#d0.kbar6 .label-primary, .btn-primary {background-color: #2f2f2f;}#muteall.kbar6 {background-color: mediumseagreen !important;}#rooms.kbar6 .label-primary, .btn-primary {background-color: #2f2f2f;}#users.kbar6 .tbox {background-color: #8a8a8a;}#room.kbar6 #mic {background-color: #555;}#room.kbar6 #mic .mic, #muteall {background-color: #2F2F2F;}#room.kbar6 .break {background-color: #555;}#room.kbar6 .tablebox.d-flex.footer.fl.light {background-color: #959595;}#users.one1 .inroom.uzr{border-radius:5px;border:1px solid #fffefe;border-bottom:1px solid #fffefe}#users.one1 .inroom.uzr img.ustat{width:10px!important;height:10px;border-radius:50%}
...
#users.kbar1 .inroom.uzr img.ustat {width: 54px !important;border-radius: 0px 50px 50px 50px !important;height: 52px !important;margin-top: -1px;min-height: 0% !important;}#users.kbar1 .inroom.uzr .fitimg.u-pic {box-shadow: inset 0 0 0 rgba(0,0,0,.08),0 0 2px #a21f1f;border: 1px solid #fff;border-radius: 50px;margin-top: -1px;z-index: 0;margin-left: -53px;}
