...
#mic0.kbar4::before {content: "(1)";border-radius: 0px 15px 15px 0px;color: black;background-color: #ffa5a5;font-size: 12px;}
#mic1.kbar5::before {content: "(2)";border-radius: 0px 15px 15px 0px;color: black;background-color: #ffa5a5;font-size: 12px;}
#mic2.kbar6::before {content: "(3)";border-radius: 0px 15px 15px 0px;color: black;background-color: #ffa5a5;font-size: 12px;}
#mic3.kbar7::before {content: "(4)";border-radius: 0px 15px 15px 0px;color: black;background-color: #ffa5a5;font-size: 12px;}
#mic4.kbar8::before {content: "(5)";border-radius: 0px 15px 15px 0px;color: black;background-color: #ffa5a5;font-size: 12px;}
`);
var room_set = false;
