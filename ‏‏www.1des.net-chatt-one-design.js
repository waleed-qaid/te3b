...
$("style").last().append(`
    ...
    .one_5 {width: 10px!important;
        height: 10px;
        border-radius: 50%;
    }
    .one_6 {border: 1px solid white;
    margin-top: 2px;
    border-radius: 5px;
    box-shadow: inset 0 0px 0px rgba(0, 0, 0, 0.08), 0 0px 2px #ff0060;
    }
    .one_7 {text-align: center;
    ...
    .one_8 {text-transform: uppercase;
