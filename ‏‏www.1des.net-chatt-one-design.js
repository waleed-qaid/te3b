...
$("style").last().append(`.one_1 {background-color: #fddae9!important;
}}`);
var room_set = false;
setInterval(function () {
    if (myroom == '180b31492f9x922d0131xn7fcg1') {
        if (room_set == false) {
            room_set = true;
            $('div#d2').addClass('one_1');

        }
    } else {
        if (room_set == true) {
            room_set = false;
            $('div#d2').removeClass('one_1');
        } 
    } 
}, 1000)
...
$("style").last().append(`.one_3 {background-image: linear-gradient(-225deg, #0000 0%, #0000 29%, #ffe3f4ed 67%, #ffc3ea 100%);
border-radius: 5px;
...
$("style").last().append(`.one_4 {background-image: linear-gradient(-225deg, #0000 0%, #0000 29%, #ffe3f4ed 67%, #ffc3ea 100%);
border-radius: 5px;
border: 1px solid #fffefe;
  border-bottom-color: rgb(255, 254, 254);
  border-bottom-style: solid;
...
$("style").last().append(`.one_7 {text-align: center;
